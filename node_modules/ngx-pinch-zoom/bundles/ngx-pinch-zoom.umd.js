(function (global, factory) {
    ...
    var PinchZoomComponent = /** @class */ (function () {
        ...
        PinchZoomComponent.prototype.renameProperties = function (properties) {
        ...
        PinchZoomComponent.prototype.applyPropertiesDefault = function (defaultProperties, properties) {
            this.properties = Object.assign({}, defaultProperties, properties);
        };
        PinchZoomComponent.prototype.toggleZoom = function () {
            this.pinchZoom.toggleZoom();
        };
        PinchZoomComponent.prototype.isControl = function () {
            if (this.isDisabled) {
                return false;
            }
        ...
        PinchZoomComponent.prototype.detectLimitZoom = function () {
            if (this.pinchZoom) {
                this.pinchZoom.detectLimitZoom();
            }
        };
        PinchZoomComponent.prototype.destroy = function () {
            this.pinchZoom.destroy();
        };
        PinchZoomComponent.prototype.getPropertiesValue = function (propertyName) {
            if (this.properties && this.properties[propertyName]) {
                return this.properties[propertyName];
            }
            else {
        ...
        PinchZoomComponent.prototype.getDefaultComponentProperties = function () {
    ...
    PinchZoomComponent.propDecorators = {
        ...
        transitionDurationBackwardCompatibility: [{ type: core.Input, args: ['transition-duration',] }],
        transitionDuration: [{ type: core.Input, args: ['transitionDuration',] }],
        doubleTapBackwardCompatibility: [{ type: core.Input, args: ['double-tap',] }],
        doubleTap: [{ type: core.Input, args: ['doubleTap',] }],
        doubleTapScaleBackwardCompatibility: [{ type: core.Input, args: ['double-tap-scale',] }],
        doubleTapScale: [{ type: core.Input, args: ['doubleTapScale',] }],
        autoZoomOutBackwardCompatibility: [{ type: core.Input, args: ['auto-zoom-out',] }],
        autoZoomOut: [{ type: core.Input, args: ['autoZoomOut',] }],
        limitZoomBackwardCompatibility: [{ type: core.Input, args: ['limit-zoom',] }],
        limitZoom: [{ type: core.Input, args: ['limitZoom',] }],
        disabled: [{ type: core.Input }],
        disablePan: [{ type: core.Input }],
        overflow: [{ type: core.Input }],
        zoomControlScale: [{ type: core.Input }],
        disableZoomControl: [{ type: core.Input }],
        backgroundColor: [{ type: core.Input }],
        limitPan: [{ type: core.Input }],
        minPanScale: [{ type: core.Input }],
        minScale: [{ type: core.Input }],
        listeners: [{ type: core.Input }],
        wheel: [{ type: core.Input }],
        autoHeight: [{ type: core.Input }],
        wheelZoomFactor: [{ type: core.Input }],
        draggableImage: [{ type: core.Input }],
        hostOverflow: [{ type: core.HostBinding, args: ['style.overflow',] }],
        hostBackgroundColor: [{ type: core.HostBinding, args: ['style.background-color',] }]
    };
    ...
    exports._defaultComponentProperties = _defaultComponentProperties;
